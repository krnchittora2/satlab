                    ...
                    <div class="row portfolio-grid justify-content-center">
                        <div class="col-lg-3 col-md-4 all">
                            <div class="our-team">
                                ...
                                <div class="team-content">
                                    <h3 class="title">&nbsp;<br>Sanskriti<br>Bhansali</h3>
                        ...
                        <div class="col-lg-3 col-md-4 all">
                            <div class="our-team">
                                ...
                                <div class="team-content">
                                    <h3 class="title">&nbsp;<br>Shaun <br> Zacharia</h3>
                                    <!--<span class="post">Web Developer</span>-->
                                </div>
                                <ul class="social">
                        ...
                        <div class="col-lg-3 col-md-4 all STADS">
                            <div class="our-team">
                                ...
                                <div class="team-content">
                                    <h3 class="title">&nbsp;<br>Neilabh <br> Banzal</h3>
                                    <!--<span class="post">Web Developer</span>-->
                                </div>
                                <ul class="social">
                        ...
                        <div class="col-lg-3 col-md-4 all RVD">
                            <div class="our-team">
                                ...
                                <div class="team-content">
                                    <h3 class="title">&nbsp;<br>Piyush <br> Jirwankar</h3>
                                    <!--<span class="post">Web Developer</span>-->
                                </div>
                                <ul class="social">
                        ...
                        <div class="col-lg-3 col-md-4 all Sanket">
                            <div class="our-team">
                                ...
                                <div class="team-content">
                                    <h3 class="title">&nbsp;<br>Karan <br> Jagdale</h3>
                                    <!--<span class="post">Web Developer</span>-->
                                </div>
                                <ul class="social">
                        ...
                        <div class="col-lg-3 col-md-4 all RVD">
                            <div class="our-team">
                                ...
                                <div class="team-content">
                                    <h3 class="title">&nbsp;<br>Dhananjay <br> Tiwari</h3>
                                    <!--<span class="post">Web Developer</span>-->
                                </div>
                                <ul class="social">
