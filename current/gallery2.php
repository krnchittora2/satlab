...
<br><br><br><br><br><br>
    <!-- <div id="main_area"> -->
        ...
        <div class="row">
            <div class="col-sm-4 padding-0" id="slider-thumbs">
                <ul class="hide-bullets">
                    ...
                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-1"><img src="images/galleryPics/dinner_with_ipgp_team.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-2"><img src="images/galleryPics/national_science_day_at_selu.png"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-3"><img src="images/galleryPics/exisro_chairman_dr_radhkrishnan.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-4"><img src="images/galleryPics/exnasa_administrator_charles_bouldon.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-5"><img src="images/galleryPics/flag_off_ceremony.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-6"><img src="images/galleryPics/flag_off_ceremony_1.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-7"><img src="images/galleryPics/harbin_institute_forum.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-8"><img src="images/galleryPics/iac_2014.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-9"><img src="images/galleryPics/iac_20141.jpg"></a>
                    </li>
                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-10"><img src="images/galleryPics/iysc_2016.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-11"><img src="images/galleryPics/pratham_team__ipgp.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-12"><img src="images/galleryPics/satellite_lab_iitb.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-13"><img src="images/galleryPics/team_lukkha.jpg"></a>
                    </li>
                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-14"><img src="images/galleryPics/team_outing.jpg"></a>
                    </li>

                    <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-15"><img src="images/galleryPics/team_treat.jpg"></a>
                    </li>

                     <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-16"><img src="images/galleryPics/tech_expo_2015.png"></a>
                    </li>

                     <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-17"><img src="images/galleryPics/techfest_2017.jpg"></a>
                    </li>

                     <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-18"><img src="images/galleryPics/visit_of_dr_kiran_rao_isro_chairman.jpg"></a>
                    </li>

                     <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-19"><img src="images/galleryPics/visit_of_dr_k_sivan_vssc_director.jpg"></a>
                    </li>

                     <li class="col-sm-4">
                        <a class="thumbnail" id="carousel-selector-20"><img src="images/galleryPics/visit_of_sudhakar_sir_exfacad.jpg"></a>
                </ul>
            </div>
            <div class="col-sm-6 ">
                <br><br><br><br><br><br><br><br>   
                <div class="col-xs-12 created" id="slider" style="margin-left: 100px;">
                    <!-- Top part of the slider -->
                    <div class="row">
                        <div class="col-sm-12" id="carousel-bounding-box">
                            <div class="carousel slide" id="myCarousel" style="width: 800px;" style=" margin-top:40px">
                                <!-- Carousel items -->
                                <div class="carousel-inner padding-1">
                                    <div class="active item" data-slide-number="0">
                                        <img src="images/galleryPics/clean_room_iitb.jpg">
                                        <div class="carousel-caption d-none d-md-block" style="background-color:rgba(20,20,20,0.6); padding-top: 7px; padding-bottom: 7px;">
                                        <h3> Cleaning room </h3>
                                    ...
                                    <div class="item" data-slide-number="1">
                                        ...
                                        <div class="carousel-caption d-none d-md-block" style="background-color:rgba(200,200,200,0.5); max-height: 25%">
