...
<?php $title = 'Blogs'; include 'header.php'; ?>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 text-center blogs_head">
				<h1>Our Blogs</h1>
				<hr>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div id="myBtnContainer">
				  ...
				  <button class="btn" onclick="filterSelection('cat-pratham')"> Pratham</button>
				  <button class="btn" onclick="filterSelection('cat-hrc')"> HRC</button>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-lg-4 filterDiv cat-pratham">
				<div class="blog_card">
					...
					<div class="blog_card_footer">
						<span class="read_more"><a href="https://theiinaniitian.wordpress.com/2017/09/26/the-making-of-pratham-satellite/" target="_blank">Read More</a></span>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-lg-4 filterDiv cat-pratham">
				<div class="blog_card">
					...
					<div class="blog_card_footer">
						<span class="read_more"><a href="http://anmoldiaries.blogspot.in/2017/09/when-satellite-launched-us.html" target="_blank">Read More</a></span>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-lg-4 filterDiv cat-pratham">
				<div class="blog_card">
					...
					<div class="blog_card_footer">
						<span class="read_more"><a href="https://theiinaniitian.wordpress.com/2017/09/28/a-40-hour-adventure-prathams-thermo-vacuum-test/" target="_blank">Read More</a></span>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-lg-4 filterDiv cat-hrc">
				<div class="blog_card">
					...
					<div class="blog_card_body">
						<div class="blog_card_category"><a href="https://theiinaniitian.wordpress.com/2017/09/28/a-40-hour-adventure-prathams-thermo-vacuum-test/" target="_blank">HRC</a></div>
						<div class="blog_card_title"><a href="https://theiinaniitian.wordpress.com/2017/09/28/a-40-hour-adventure-prathams-thermo-vacuum-test/" target="_blank">HRC Blog 1</a></div>
						<div class="blog_card_subtitle"><i class="glyphicon glyphicon-user"></i>&nbsp;Yash Sanghvi</div>
						<p class="blog_card_description">More often than not, superlatives are found in the most unexpected of places. The purest form of beauty, for instance, can be found in simplicity. The purest form of happiness can be found in tears...</p>
					</div>
					<div class="blog_card_footer">
			...
			<div class="col-xs-12 col-sm-6 col-lg-4 filterDiv cat-hrc">
				<div class="blog_card">
					...
					<div class="blog_card_body">
						<div class="blog_card_category"><a href="https://theiinaniitian.wordpress.com/2017/09/28/a-40-hour-adventure-prathams-thermo-vacuum-test/" target="_blank">HRC</a></div>
						<div class="blog_card_title"><a href="https://theiinaniitian.wordpress.com/2017/09/28/a-40-hour-adventure-prathams-thermo-vacuum-test/" target="_blank">HRC Blog 2</a></div>
						<div class="blog_card_subtitle"><i class="glyphicon glyphicon-user"></i>&nbsp;Yash Sanghvi</div>
						<p class="blog_card_description">More often than not, superlatives are found in the most unexpected of places. The purest form of beauty, for instance, can be found in simplicity. The purest form of happiness can be found in tears...</p>
					</div>
					<div class="blog_card_footer">
			...
			<div class="col-xs-12 col-sm-6 col-lg-4 filterDiv cat-hrc">
				<div class="blog_card">
					...
					<div class="blog_card_body">
						<div class="blog_card_category"><a href="https://theiinaniitian.wordpress.com/2017/09/28/a-40-hour-adventure-prathams-thermo-vacuum-test/" target="_blank">HRC</a></div>
						<div class="blog_card_title"><a href="https://theiinaniitian.wordpress.com/2017/09/28/a-40-hour-adventure-prathams-thermo-vacuum-test/" target="_blank">HRC Blog 3</a></div>
						<div class="blog_card_subtitle"><i class="glyphicon glyphicon-user"></i>&nbsp;Yash Sanghvi</div>
						<p class="blog_card_description">More often than not, superlatives are found in the most unexpected of places. The purest form of beauty, for instance, can be found in simplicity. The purest form of happiness can be found in tears...</p>
					</div>
					<div class="blog_card_footer">
