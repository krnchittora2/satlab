...
<?php $title = 'Home'; include 'header.php'; ?>
  ...
  <section class="landing">
    ...
    <h2 id="text">IIT Bombay<br>Student Satellite Project</h2>
  </section>
      ...
      <div class="carousel-inner">
        <div class="item active">
          ...
          <div class="carousel-caption">
            <h3>Pratham</h3>
            <p>India’s first satellite designed completely by students. Launched onboard ISRO’s PSLV C-35 on 26 September 2016. Beacon signal received on 28th September at IITB’s own ground station. Took IIT Bombay into the elite space club and became the ‘First Step Towards Infinity’.<br><br>
            <a href="#" class="btn btn-success">Know More >></a></p>
          </div>
          <a href="#" class="mobile-only btn btn-success">Know More >></a>
        </div>
        <div class="item">
          <img src="img/pratham.jpg" />
          <div class="carousel-caption">
            <h3>Advitiy</h3>
            <p>Content Here<br><br>
            <a href="#" class="btn btn-success">Know More >></a></p>
          </div>
          <a href="#" class="mobile-only btn btn-success">Know More >></a>
        </div>
        <div class="item">
          ...
          <div class="carousel-caption">
            ...
            <p>A mission aiming to pioneer a simulation framework for Guidance, Navigation and Control for autonomous rendezvous and docking of one 6U CubeSat, called the chaser, to another, called the target; under the purview of GNC subsystem. Something pretty similar to the docking mechanism in the movie Interstellar.<br><br>
            <a href="#" class="btn btn-success">Know More >></a></p>
          </div>
          <a href="#" class="mobile-only btn btn-success">Know More >></a>
        </div>
        <div class="item">
          ...
          <div class="carousel-caption">
            ...
            <p>A device to measure the attitude (orientation) of the satellites in space. Makes use of the distance from the stars to estimate the attitude over the traditional methods that involve a combination of the sun sensor and magnetometer. The greater number of data points make it the most accurate way to measure the attitude of a satellite.<br><br>
            <a href="#" class="btn btn-success">Know More >></a></p>
          </div>
          <a href="#" class="mobile-only btn btn-success">Know More >></a>
        </div>
        ...
        <div class="col-xs-6 col-sm-3">
          <div class="social-links">
            ...
            <ul>
              ...
              <li><a href="https://www.facebook.com/iitb.student.satellite/" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
        ...
        <div class="col-xs-6 col-sm-3">
          <div class="quick-links">
            ...
            <ul>
              ...
              <li><a href="#">HAM Radio Club</a></li>
              <li><a href="#">Ground Station</a></li>
              <li><a href="#">Pratham</a></li>
            ...
            <div class="media">  
              ...
              <div class="parrent pull-left">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tab1" data-toggle="tab">Current Project Manager</a> 
                    <li class=""><a href="#tab2" data-toggle="tab">Current Faculty Advisers</a></li>
                    ...
                    <li class=""><a href="#tab5" data-toggle="tab">Ex-Faculty Advisers</a></li>
                  </ul>
              </div>
